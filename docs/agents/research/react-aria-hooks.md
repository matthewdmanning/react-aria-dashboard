...
| Drag & drop         | `useDrag`, `useDrop`, `useDraggableCollection`, `useDraggableItem`, `useDroppableCollection`, `useDropIndicator` + `useDraggableCollectionState`                                        | **Speculative.** Would matter for reordering cards on the dashboard; nothing in `src/dashboard/` needs it today.                                                                                                       |
